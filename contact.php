							...
							<div class="row">
								<div class="col-md-10 text-left menu-1">
									<ul>
										...
										<li class="active"><a href="contact.php">Persoane de contact</a></li>
									</ul>
								</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					<h2><span>Persoane de contact</span></h2>
				</div>
			</div>
			<div class="row">
					...
					<form action="thanks.php" method="post">
						...
						<div class="form-group row">
							<div class="col-md-12 field">
								...
								<input type="submit" id="submit" class="btn btn-primary" value="Trimite">
							</div>
						</div>
					</form>
				</div>
