                        ...
                        <div class="row">
                            <div class="col-md-10 text-left menu-1">
                                <ul>
                                    ...
                                    <li class="active"><a href="terms.php">Termenii și condițiile</a></li>
        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
                    <h2><span>Termenii și condițiile</span></h2>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="fh5co-blog animate-box">
                                <div class="title title-pin text-center">
                                    <span class="posted-on">02.03.2021</span>
                                ...
                                <div class="blog-text text-center">
                                    ...
                                    <p>By accessing this website we assume you accept these terms and conditions. Do not
                                        continue to use <span class="server-name"></span> if you do not agree to take
                                        all of
                                        the terms and conditions stated on this page. Our Terms and Conditions were
                                        created
                                        with the help of the <a href="https://www.termsandconditionsgenerator.com">Terms
                                            And
                                    ...
                                    <p>The following terminology applies to these Terms and Conditions, Privacy
                                        ...
                                        CompanyвЂ™s stated services, in accordance with and subject to, prevailing law
                                        of
                                    ...
                                    <p>Unless otherwise stated, <span class="server-name"></span> and/or its licensors
                                        own
                                        the intellectual property rights for all material on <span
                                                class="server-name"></span>. All intellectual property rights are
                                        reserved.
                                        You may access this from <span class="server-name"></span> for your own personal
                                        use
                                    ...
                                    <ul>
                                        ...
                                        <li>Sell, rent or sub-license material from <span class="server-name"></span>
                                        </li>
                                    ...
                                    <p>Parts of this website offer an opportunity for users to post and exchange
                                        opinions
                                        and information in certain areas of the website. <span
                                        ...
                                        website. Comments do not reflect the views and opinions of <span
                                                class="server-name"></span>,its agents and/or affiliates. Comments
                                        reflect
                                        the views and opinions of the person who post their views and opinions. To the
                                        extent permitted by applicable laws, <span class="server-name"></span> shall not
                                        be
                                    ...
                                    <p><span class="server-name"></span> reserves the right to monitor all Comments and
                                        to
                                    ...
                                    <p>You hereby grant <span class="server-name"></span> a non-exclusive license to
                                        use,
                                    ...
                                    <p>We will approve link requests from these organizations if we decide that: (a) the
                                        ...
                                        <span
                                                class="server-name"></span>; and (d) the link is in the context of
                                        general
                                    ...
                                    <p>If you are one of the organizations listed in paragraph 2 above and are
                                        ...
                                        name, contact information as well as the URL of your site, a list of any URLs
                                        from
                                    ...
                                    <p>No use of <span class="server-name"></span>'s logo or other artwork will be
                                        allowed
                                    ...
                                    <p>We do not ensure that the information on this website is correct, we do not
                                        warrant
                                        its completeness or accuracy; nor do we promise to ensure that the website
                                        remains
